...
def main(
    ...
    if args.do_train:
        ...
        t0 = time.time()
        training_stopped = False  # Flag to indicate if training should be stopped
        for epoch in tqdm.trange(
            ...
            for it, batch in pbar:
                ...
                if global_step == args.end_step:
                    print("Reached the end step. Stopping training.")
                    training_stopped = True
                    break


            # If global_step reached args.end_step, break out of the epoch loop as well
            if training_stopped:
                break
