...
class Arguments:
    ...
    constant_lr: float = field(
        default=1.0, metadata={"help": "Learning rate min in schedule."}
    )

    constant_ratio: float = field(
        default=0.67, metadata={"help": "Learning rate min in schedule."}
    )
    ...
    end_step: int = field(
        default=1000, metadata={"help": "End step"}
    )
