...
transformer_configs = {
    "CodeLlama-13b-Python-hf": dict(n_layer=40, n_head=40, dim=5120),
    "deepseek-coder-6.7b-base": dict(
        block_size=4096, vocab_size=32256, n_layer=32, n_head=32, dim=4096, rope_base=1000000, intermediate_size=11008, norm_eps=1e-6,
    ),
    "CodeLlama-7b-Python-hf": dict(
        block_size=16384, vocab_size=32000, n_layer=32, dim=4096, rope_base=1000000
    ),
    "Mistral-7B-v0.1": dict(
        block_size=4096, n_layer=32, n_head=32, dim=4096, intermediate_size=14336, n_local_heads=8,
    ),
    "Mistral-7B-Instruct-v0.1": dict(
        block_size=4096, n_layer=32, n_head=32, dim=4096, intermediate_size=14336, n_local_heads=8,
    ),
    # 给Meta-Llama-3-8B添加两个special token, 继续训练
    "Meta-Llama-3-8B": dict(
        block_size=4096, n_layer=32, n_head=32, dim=4096, intermediate_size=14336, n_local_heads=8,
        rope_base=500000, norm_eps=1e-5,vocab_size=128256,
    ),
    ...
    "Meta-Llama-3-70B": dict(
        block_size=8192, n_layer=80, n_head=64, dim=8192, intermediate_size=28672, n_local_heads=8,
        rope_base=500000, norm_eps=1e-5,vocab_size=128256,
    ),
