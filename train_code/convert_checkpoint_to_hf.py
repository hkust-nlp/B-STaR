...
def load_and_merge_models(
    ...
    for key in state_dict.keys():
        ...
        if "wqkv" in key:
            ...
            print("state_dict[key].size(2)", state_dict[key].size(2))



            if state_dict[key].size(2) == 4096:
                if "Mistral-7B-v0.1" in pretrain_name:
                    n_heads, n_local_heads = 32, 8
                    print("Mistral-7B-v0.1")

                elif "Mistral-7B" in pretrain_name:
                    n_heads, n_local_heads = 32, 8
                    print("Mistral-7B")

                elif "Meta-Llama-3-8B" in pretrain_name:
                    n_heads, n_local_heads = 32, 8
                    print("Meta-Llama-3-8B")

                elif "Llama-3.1-8B" in pretrain_name:
                    n_heads, n_local_heads = 32, 8
                    print("Meta-Llama-3-8B")                    
                elif "Meta-Llama-3-70B" in pretrain_name:
                    n_heads, n_local_heads = 64, 8
                    print("Meta-Llama-3-70B")                       
                else:
