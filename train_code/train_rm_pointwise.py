...
from data_utils.data_utils_rm_pointwise import (
    ...
    make_pointwise_reward_modeling_data_module_llama3,
)
...
from checkpoint_utils import (
    ...
    load_reward_model_from_sft_ckpt_llama3,
    load_reward_model_from_sft_ckpt_deepseek,
)
...
def main(
    ...
    if "Meta-Llama-3" in str(checkpoint_path):
        # model = load_reward_model_from_sft_ckpt_llama3(
        #     checkpoint_path,
        #     sft_checkpoint_path,
        #     device,
        #     precision,
    ...
    if "Meta-Llama-3" in str(checkpoint_path):
        data_module = make_pointwise_reward_modeling_data_module_llama3(
            tokenizer=tokenizer,
            args=args,
        )
    elif "Llama-3.1" in str(checkpoint_path):
